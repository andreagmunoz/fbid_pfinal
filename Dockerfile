...
COPY ./airflow_home/resources/airflow/requirements.txt /opt/airflow/requirements.txt
COPY ./airflow_home/resources/airflow/constraints.txt /opt/airflow/constraints.txt
...
COPY airflow_home/init_user.sh /usr/local/bin/init_user.sh
